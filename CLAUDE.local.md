...
**YOU ARE IN: `MusicolabHub/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/MusicolabHub/` (rig root) or other directories
...
**Your mail address:** `MusicolabHub/polecats/obsidian`
**Your rig:** MusicolabHub
**Your Witness:** `MusicolabHub/witness`
...
| Ask Witness for help | `gt mail send MusicolabHub/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`MusicolabHub/witness`) when:
...
```bash
gt mail send MusicolabHub/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
