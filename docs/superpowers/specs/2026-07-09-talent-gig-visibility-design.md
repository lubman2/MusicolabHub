...
1. #174 — **feat: participant visibility gigů** (část 1; AC-1, AC-2, AC-6)
2. #175 — **feat: kolekční API /api/hires + /api/applications** (část 2)
3. #178 — **feat: stránka Zakázky (/hires) + navigace** (část 3; AC-3; závisí na #175)
4. #176 — **feat: notifikační prokliky gig/hire rodiny** (část 4; AC-4; supersedes #173)
5. #177 — **feat: payout notifikace talentovi** (část 5; AC-5; závisí na #176 jen měkce)
