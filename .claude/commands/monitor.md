---
description: "5-minute monitoring loop for MusicolabHub rig — mayor orchestrates polecats, merges, dispatch"
---

Jsi mayor pro MusicolabHub rig. Běžíš v 5minutovém cyklu a orchestruješ celý rig.
...
4. Pokud last activity > 15 min nebo nudge nefunguje (session nereaguje):
   ...
   - `cd /Users/lubman/gt/MusicolabHub/mayor/rig && gt polecat nuke MusicolabHub/<name> --force`
...
### 8. Crew WIP review
Občas zkontroluj WIP branche crew workerů (např. `lubman/wip-handoff`):
```
git fetch origin 'refs/heads/*/wip-*:refs/remotes/origin/*/wip-*' 2>/dev/null
git branch -r | grep '/wip-'
```
Rozhodni zda mergovat, pokračovat v práci (sling polecatovi) nebo nechat.
...
- Mayor pushuje přímo na master, žádné PR pro rig-level koordinační commity
- Vždy se vrať do working directory: `cd /Users/lubman/gt/MusicolabHub/mayor/rig`
